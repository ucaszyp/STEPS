...
def convert_bn_to_in(module: nn.Module):
    """
    Convert batch_norm_2d in a given module to instance_norm_2d
    :param module:
    :return:
    """
    module_output = module
    if isinstance(module, nn.BatchNorm2d):
        module_output = nn.InstanceNorm2d(module.num_features, module.eps, affine=module.affine,
...
def get_non_linear(non_linear: str):
    if non_linear == 'elu':
        ...
        raise ValueError('Unsupported non_linear layer: {}.'.format(non_linear))
